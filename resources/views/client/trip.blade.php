    ...
    <body>
        ...
        <div class="about">
            ...
            <form action="{{ route('client.booking.store') }}" method="post">
                ...
                <hr id="gold">
                <div class=" py-4">
                    <input class="input-contact" type="text" placeholder="Full Name *" value="{{ old('name') }}" name="name" required>
                    @error('name')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="  py-4">
                    <input class="input-contact" type="email" placeholder="E-Mail *" value="{{ old('email') }}" name="email" required>
                    @error('email')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="  py-4">
                    <input class="input-contact" type="text" placeholder="Your Phone Number *" value="{{ old('phone') }}" name="phone" required>
                    @error('phone')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="  py-4">
                    <input class="input-contact" type="number" placeholder="Number of persons*" value="{{ old('person') }}" name="person" required>
                    @error('person')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="  py-4">
                    ...
                    <input class="input-contact" type="date" name="arrival" value="{{ old('arrival') }}" id="arrival"  required>
                    @error('arrival')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="  py-4">
                    ...
                    <input class="input-contact" type="date" name="departure" value="{{ old('departure') }}" id="departure" required>
                    @error('departure')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
